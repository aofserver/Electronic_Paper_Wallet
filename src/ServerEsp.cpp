...
ServerEspClass::ServerEspClass()
{
}

void ServerEspClass::begin()
{
  std::cout << "\n... Begin ServerEsp ...";
}


// void ServerEspClass::SetCors()
// {
//   server.enableCORS();
...
//     String path = "";
//     if(Storage.readFile("/config_wifi.txt") == ""){
//       path = "setting";
//     }
//     else {
//       path = "wallet";
...
// void ServerEspClass::Listening()
// {
//   server.handleClient();
// }

String ServerEspClass::Redirect() {
  String path = "";
  if(Storage.readFile("/config_wifi.txt") == ""){
    path = "setting";
  }
...
String ServerEspClass::PageHelp() {
...
String ServerEspClass::PageWallet(String myWallet) {
  String HTML PROGMEM = R"=====(
                                <!DOCTYPE HTML><html lang='en-US'><meta http-equiv='Content-Type' content='text/html; charset=UTF-8' /><meta name='viewport' content='width=device-width,initial-scale=1,user-scalable=no' /></head>
                                <body style="background-color: #515A5A;">
                                <script type='text/javascript'>
...
String ServerEspClass::PageAddWallet(String config_auth) {
  String HTML PROGMEM = R"=====(
                                <!DOCTYPE HTML>
                                <html lang='en-US'>
...
String ServerEspClass::PageDeleteWallet(String config_auth, String myWallet) {
  String HTML PROGMEM = R"=====(
                                <!DOCTYPE HTML>
                                <html lang='en-US'>
                                <meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />
...
String ServerEspClass::PageSetting() {
  String HTML PROGMEM = R"=====(
...
String ServerEspClass::PageNotFound() {
  String HTML PROGMEM = R"=====(
                                <!DOCTYPE HTML><html lang='en-US'><meta http-equiv='Content-Type' content='text/html; charset=UTF-8' /><meta name='viewport' content='width=device-width,initial-scale=1,user-scalable=no' /></head>
                                <body style="background-color: #515A5A;">
                                <script type='text/javascript'>
